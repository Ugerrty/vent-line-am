...
en: {
  ...
  'mf.f1':'founded','mf.v2':'48 h','mf.f2':'specification from a floor plan','mf.v3':'1 day','mf.f3':'working documentation','mf.f4':'cities of presence',
  ...
  'ye.h2':'Yerevan',
  'ye.lead':'Armenia is building a record amount of premium housing — and the invisible-ventilation segment doesn’t exist on the market yet. We arrive with the full cycle at once: design, supply, installation and maintenance — our own crews in Yerevan.',
...
hy: {
  ...
  'nav.line':'Վանդակներ','nav.spaces':'Նախագծեր','nav.design':'Նախագծում','nav.service':'Սպասարկում','nav.yerevan':'Երևան','nav.contact':'Կապ',
  'hero.kicker':'Նախագծում · մատակարարում · մոնտաժ · սպասարկում',
  'hero.h1a':'Օդափոխություն,',
  'hero.h1b':'որը չի երևում',
  ...
  'line.h2':'Վանդակներ՝ սեփական արտադրության',
  ...
  'unit.mm':'մմ',
  'line.l1':'տեսանելի ճեղք','line.l2b':'ցանկացած','line.l2':'երկարություն՝ առանց կարերի','line.l3':'RAL · անոդացում · երեսպատում',
  'line.color':'Գույն','line.cb':'Սև','line.cw':'Սպիտակ',
  'pj.kicker':'Նախագծեր',
  'pj.h2':'Մոնտաժված է՝ և լուծված ինտերիերի մեջ',
  'pj.lead':'Կադրեր մեր օբյեկտներից. վանդակներն արդեն շնչում են այս առաստաղներում և պատերում՝ պարզապես դրանք չեն երևում։',
  ...
  'sh1.c':'Մոսկվա','sh2.c':'Հայաստան','sh2.t':'Նախագծեր Երևանում',
  'sh3.c':'Մոսկվայի մարզ','sh4.c':'ԱՄԷ','sh4.t':'Մասնավոր տներ, Դուբայ',
  'sh5.c':'Թաիլանդ','sh5.t':'Ռեզիդենսներ, Բանգկոկ',
  ...
  'sil.s1':'արագությունը ճեղքում՝ անաղմուկության շեմը',
  'sil.s2':'օդի ծախսը մեկ գծի վրա',
  'sil.s3':'խոնավություն ցողային խոնավացմամբ',
  'ds.kicker':'Նախագծում',
  'ds.h2':'Օդափոխության բաժին՝ ձեր նախագծի համար',
  'ds.lead':'Հաշվում ենք օդափոխանակությունը հատակագծերի համար, թաքնված վանդակները ներդնում ենք ճարտարապետության մեջ և հանձնում փաստաթղթեր, որոնցով կարելի է կառուցել։',
  ...
  'ds2.t':'Բնութագիր և նախահաշիվ','ds2.x':'Նախնական բնութագիր և նախահաշիվ հատակագծով՝ մինչև պայմանագրի մեկնարկը։','ds2.m':'48 ժամ',
  ...
  'sv.h2':'Մոնտաժում ենք՝ և մնում կողքին',
  ...
  'sv2.t':'Պլանային սպասարկում','sv2.x':'Ճեղքերի և վանդակների մաքրում, ամրացումների ստուգում, կրկնակի հավասարակշռում՝ ձեր օբյեկտի գրաֆիկով։','sv2.m':'գրաֆիկով',
  'sv3.t':'Խոնավացման սպասարկում','sv3.x':'Սպասարկում ենք բարձր ճնշման ցողային համակարգերը՝ ֆորսունկաներ, ֆիլտրեր, ավտոմատիկա։ 40–60 % խոնավություն ամբողջ տարին։',
  'sv4.t':'Երաշխիք և աջակցություն','sv4.x':'Արտադրողի երաշխիք վանդակների և կատարված մոնտաժի համար՝ և սերվիսային աջակցություն օբյեկտի հանձնումից հետո։','sv4.m':'հանձնումից հետո',
  'ye.kicker':'Նոր գլուխ',
  'ye.h2':'Երևան',
  ...
  'ye.r3b':'48 ժամ','ye.r3':'նախնական բնութագիր և նախահաշիվ ձեր հատակագծով',
  'ye.msk':'Մոսկվա','ye.evn':'Երևան',
  'ct.kicker':'Կապ',
  'ct.h2':'Քննարկենք ձեր օբյեկտը',
  'ct.lead':'Ուղարկեք հատակագիծը՝ 48 ժամում կվերադարձնենք նախնական բնութագիրը, նախահաշիվը և ժամկետները։',
  ...
  'form.note':'Կոճակը կբացի նամակ ձեր փոստում՝ ոչինչ չի ուղարկվի առանց հաստատման։',
  'footer.legal':'© 2011–2026 Vent-Line · ԱՁ Գ. Սպիրիդոնով · ՀՎՀՀ 772994390219 · Արտադրությունը՝ Մոսկվայի մարզ · Մոնտաժը՝ Երևան'
}
};
