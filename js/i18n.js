...
en: {
  ...
  'menu.open': 'Open menu',
  'nav.brand':'Brand','nav.line':'Line','nav.system':'System','nav.product':'Product',
  ...
  'hero.btn1':'Request a quote','hero.btn2':'See the line',
  'hero.hint':'scroll',
  ...
  'system.c3x':'High-pressure mist humidification — as invisible as the diffusers: nozzles are hidden, humidity stays in the 40–60 % comfort zone all year round. In dry continental climates it is an essential part of the design.',
  'system.c4t':'Installation',
  'system.c4x':'Installation is done by our own crews: rough and finish stages, templates, commissioning, acceptance report. One engineer stays with the project from selection to handover; in Yerevan we have our own installation team.',
  ...
  'process.t4':'Delivery','process.x4':'We deliver across Russia and the CIS, to the UAE and Thailand. To Armenia, cargo travels with no duties or customs clearance — the single EAEU space, EAC certification.','process.m4':'4 destinations',
  'process.t5':'Installation & handover','process.x5':'A Vent-Line crew installs at rough and finish stages, commissions the system and hands the site over with an acceptance report.','process.m5':'turnkey',
